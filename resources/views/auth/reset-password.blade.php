    ...
    <div class="rex-auth-shell">
        ...
        <form method="POST" action="{{ route('password.store') }}" class="rex-auth-form">
            ...
            <div class="rex-auth-field">
                ...
                <input id="password" class="rex-auth-input" type="password" name="password" required autocomplete="new-password" placeholder="Create a new password">
            ...
            <div class="rex-auth-field">
                ...
                <input id="password_confirmation" class="rex-auth-input" type="password" name="password_confirmation" required autocomplete="new-password" placeholder="Confirm your new password">
