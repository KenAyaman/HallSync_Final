...
<div x-data="{ open: false, notificationsOpen: false }" class="admin-nav-wrapper" x-cloak>

    {{-- Minimal Burger Button (no brown box, just gold lines) --}}
    <button @click="open = !open; if (!open) notificationsOpen = false"
        ...
        @if(($navNotificationCount ?? 0) > 0)
            <span class="burger-notification-badge" aria-label="{{ $navNotificationCount }} unread notifications">
    ...
    <aside class="admin-sidebar"
        ...
        <nav class="sidebar-nav">
            ...
            <a href="{{ route('bookings.index') }}" class="nav-item {{ request()->routeIs('bookings.*') || request()->routeIs('admin.bookings.*') ? 'nav-active' : '' }}">
                ...
                @if(isset($upcomingBookingsCount) && $upcomingBookingsCount > 0)
                    <span class="nav-badge">{{ $upcomingBookingsCount }}</span>
                @endif
            </a>
            ...
            {{-- Community --}}
            <a href="{{ route('admin.community') }}" class="nav-item {{ request()->routeIs('community.*') || request()->routeIs('admin.community') ? 'nav-active' : '' }}">
                <div class="nav-icon-wrap">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <a href="{{ route('admin.users') }}" class="nav-item {{ request()->routeIs('admin.users*') ? 'nav-active' : '' }}">
                <div class="nav-icon-wrap">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <x-sidebar-notifications collapsible :nav-notifications="$navNotifications ?? collect()" :nav-notification-count="$navNotificationCount ?? 0" />
...
.burger-notification-badge {
    ...
    font-weight: 700;
    line-height: 1;
    box-shadow: 0 4px 10px rgba(92, 34, 28, 0.26);
}
.burger-active .burger-notification-badge {
    border-color: rgba(52, 49, 44, 0.96);
}
