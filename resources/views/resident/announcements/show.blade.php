<x-app-layout>
    ...
    <div class="resident-announcement-page">
        <div class="resident-announcement-topbar">
            <a href="{{ route('announcements.index') }}" class="resident-back-link resident-create-back">← Back</a>
        </div>
...
.resident-announcement-topbar {
    display: flex;
    align-items: center;
    justify-content: flex-start;
}
.resident-announcement-hero, .resident-announcement-panel {
...
.resident-announcement-highlight, .resident-announcement-meta-item {
    border-radius: 16px;
...
.resident-announcement-highlight span, .resident-announcement-meta-item span {
    display: block;
    color: #A89376;
    font-size: 0.72rem;
    text-transform: uppercase;
...
.resident-announcement-highlight strong, .resident-announcement-meta-item strong {
    display: block;
    margin-top: 6px;
    color: #F0E9DF;
    font-size: 1rem;
...
@media (max-width:560px) {
    ...
    .resident-announcement-hero-actions, .resident-announcement-btn {
        width: 100%;
    }
}
</style>
