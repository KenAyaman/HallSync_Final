<x-app-layout>
    ...
    <div class="resident-booking-page">
        <div class="resident-booking-topbar">
        ...
        <section class="resident-booking-panel">
            ...
            <div class="resident-booking-detail-list">
                ...
                @if($booking->group_members)
                    <div class="resident-booking-detail-box">
                        <span>Roommates / Group Members</span>
                        <strong>{{ $booking->group_members }}</strong>
                    </div>
                @endif
            </div>
        </section>
...
.resident-booking-topbar {
    display: flex;
    align-items: center;
    justify-content: flex-start;
}
.resident-booking-hero, .resident-booking-panel {
...
.resident-booking-hero-stat span, .resident-booking-detail-box span {
    display: block;
    color: #8A7A66;
    font-size: 0.72rem;
    font-weight: 700;
...
@media (max-width:768px) {
    .resident-booking-page {
        padding: var(--m-space-4) 0 var(--m-space-6);
        gap: var(--m-gap-page);
    }
    .resident-booking-hero, .resident-booking-panel {
    ...
    .resident-booking-panel-head h2 {
        font-size: var(--m-font-section);
    }
    .resident-booking-hero-actions, .resident-booking-btn {
        width: 100%;
    }
    .resident-booking-btn {
